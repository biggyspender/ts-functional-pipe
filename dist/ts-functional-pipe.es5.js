...
var deferP0 = function (fn) {
    return function () {
        ...
        return function () {
            ...
            return fn.apply(void 0, __spreadArray([], __read(src.concat(args)), false));
        };
    };
};
...
var applyArgs = function () {
    ...
    var f = (function (fun) { return fun.apply(void 0, __spreadArray([], __read(args), false)); });
    f.to = f;
    return f;
};
...
function pipeImpl() {
    ...
    return function () {
        ...
        return operations.reduce(function (acc, f) { return f(acc); }, o1.apply(void 0, __spreadArray([], __read(argsP), false)));
    };
}
